...
/** @defgroup STM324x7I_EVAL_LCD 
  * @brief This file includes the LCD driver for AM-240320L8TNQW00H (LCD_ILI9320)
  *        and AM240320D5TOQW01H (LCD_ILI9325) Liquid Crystal Display Modules
  *        of STM324x7I_EVAL board.
  * @{
  */ 

/** @defgroup STM324x7I_EVAL_LCD_Private_TypesDefinitions
  * @{
  */ 
typedef struct
{
...
/** @defgroup STM324x7I_EVAL_LCD_Private_Defines
  * @{
  */
...
/** @defgroup STM324x7I_EVAL_LCD_Private_Macros
  * @{
  */
...
/** @defgroup STM324x7I_EVAL_LCD_Private_Variables
  * @{
  */ 
...
/** @defgroup STM324x7I_EVAL_LCD_Private_FunctionPrototypes
  * @{
  */ 
#ifndef USE_Delay
...
/** @defgroup STM324x7I_EVAL_LCD_Private_Functions
  * @{
  */ 
...
/* Configure the FMC Parallel interface -------------------------------------*/
  ...
  else if(lcdid == 0x9325) /* Check if the LCD is ILI9325 Controller */
  {
	...
	{
	     // LCD_Code = SSD1289;
	    LCD_WriteReg(0x0000,0x0001);    _delay_(50);   /* Enable LCD Oscillator */
	    LCD_WriteReg(0x0003,0xA8A4);    _delay_(50);   
	    LCD_WriteReg(0x000C,0x0000);    _delay_(50);   
	    LCD_WriteReg(0x000D,0x080C);    _delay_(50);   
	    LCD_WriteReg(0x000E,0x2B00);    _delay_(50);   
	    LCD_WriteReg(0x001E,0x00B0);    _delay_(50);   
	    LCD_WriteReg(0x0001,0x2B3F);    _delay_(50);   /* 320*240 0x2B3F */
	    LCD_WriteReg(0x0002,0x0600);    _delay_(50);
	    LCD_WriteReg(0x0010,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0011,0x6070);    _delay_(50);
	    LCD_WriteReg(0x0005,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0006,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0016,0xEF1C);    _delay_(50);
	    LCD_WriteReg(0x0017,0x0003);    _delay_(50);
	    LCD_WriteReg(0x0007,0x0133);    _delay_(50);         
	    LCD_WriteReg(0x000B,0x0000);    _delay_(50);
	    LCD_WriteReg(0x000F,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0041,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0042,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0048,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0049,0x013F);    _delay_(50);
	    LCD_WriteReg(0x004A,0x0000);    _delay_(50);
	    LCD_WriteReg(0x004B,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0044,0xEF00);    _delay_(50);
	    LCD_WriteReg(0x0045,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0046,0x013F);    _delay_(50);
	    LCD_WriteReg(0x0030,0x0707);    _delay_(50);
	    LCD_WriteReg(0x0031,0x0204);    _delay_(50);
	    LCD_WriteReg(0x0032,0x0204);    _delay_(50);
	    LCD_WriteReg(0x0033,0x0502);    _delay_(50);
	    LCD_WriteReg(0x0034,0x0507);    _delay_(50);
	    LCD_WriteReg(0x0035,0x0204);    _delay_(50);
	    LCD_WriteReg(0x0036,0x0204);    _delay_(50);
	    LCD_WriteReg(0x0037,0x0502);    _delay_(50);
	    LCD_WriteReg(0x003A,0x0302);    _delay_(50);
	    LCD_WriteReg(0x003B,0x0302);    _delay_(50);
	    LCD_WriteReg(0x0023,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0024,0x0000);    _delay_(50);
	    LCD_WriteReg(0x0025,0x8000);    _delay_(50);
...
/*-- GPIO Configuration ------------------------------------------------------*/
  ...
  GPIO_PinAFConfig(GPIOE, GPIO_PinSource15 , GPIO_AF_FMC);
	...
	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_5 | GPIO_Pin_13 | GPIO_Pin_12| GPIO_Pin_14;      
