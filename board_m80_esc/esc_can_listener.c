...
1. report
  ...
  //继电器 
	...
	dam4_02 ： 	[0x2][statusL][statusH][input1][input2][input3][input4]   //该DAM板上的输入脚接了两路检测 input2:发动机低油压报警 input3:发动机高水温报警
	dam4_04 ：	[0x4][statusL][statusH]    
	dam4_05 ：	[0x05][statusL][statusH]
	dam16_08 ：	[0x08][statusL][statusH] 
	dam4_09 ：	[0x09][statusL][statusH]
  ...
  //电压采集板： 每一个板有6路电压采样	unsigned short adc[6];
	...
	powerAdc6_06
	第一个can包：[0x60][adc0][adc1][adc2] 
	第二个can包：[0x61][adc3][adc4][adc5]
	powerAdc6_07
	第一个can包：[0x70][adc0][adc1][adc2] 
	第二个can包：[0x71][adc3][adc4][adc5]
