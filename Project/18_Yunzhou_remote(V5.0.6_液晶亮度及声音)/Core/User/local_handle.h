...
/* Exported define ------------------------------------------------------------*/
#define LOCAL_PARAMETER_QUANTITY 6				//遥控器本地配置参数（除数传模块）
#define WATER_SAMPLE_PARAMETER	6					//采水参数配置
...
#define USV_Boat_Type_ME70 			16
#define USV_Boat_Type_MMH70 		10

#define USV_Boat_Type_MC120 		11
#define USV_Boat_Type_ME120 		17
#define USV_Boat_Type_MS120 		12
#define USV_Boat_Type_MM120 		18
#define USV_Boat_Type_ME300 		13

#define USV_Boat_Type_LE2000 		14
#define USV_Boat_Type_LE3000 		15
