...
#define AUDIO_FILE_SIZE         1003382 //1513368
...
int main(void)
{
  ...
  if (EVAL_AUDIO_Init(OUTPUT_DEVICE_BOTH, uwVolume, SAI_AudioFreq_44k) == 0)
  {
    /* AUDIO CODEC OK */
    STM_EVAL_LEDOn(LED1);
  }
