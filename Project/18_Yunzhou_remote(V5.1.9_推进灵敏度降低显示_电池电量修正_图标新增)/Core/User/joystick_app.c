...
//#define BATTERY_MAX 3375
#define BATTERY_MAX 3210
#define BATTERY_MIN 2480
...
//			Battery_Power_Percent = 100 - (3238 - Battery_Power_Avg) * 100 / (3238 - 2854);
			Battery_Power_Percent = 100 - (BATTERY_MAX - Battery_Power_Avg) * 100 / (BATTERY_MAX - BATTERY_MIN);
