...
/* Exported variables ---------------------------------------------------------*/
uint32_t local_para_conf[LOCAL_PARAMETER_QUANTITY] = {1, 0, 0, 150, 0, 0, 1};					//存储遥控器本地配置参数（除数传模块）
/*------------------------------------------------------------------------------------------------
索引号			名称										描述											取值范围
...
uint32_t local_para_conf_min[LOCAL_PARAMETER_QUANTITY] = {0, 0, 0, 147, 0, 0, 0};						//定义最小值
uint32_t local_para_conf_max[LOCAL_PARAMETER_QUANTITY] = {15, 1, 18, 165, 1, 1, 1};					//定义最大值
