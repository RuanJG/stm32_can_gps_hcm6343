...
* Description    : Configure Open407V_USART 
* Input          : None
* Output         : None
* Return         : None
* Attention			 : None
...
{ 												
  ...
  RCC_APB1PeriphClockCmd(Open407V_USART_CLK,ENABLE);
  ...
  /*
  *  Open407V_USART_TX -> PC10 , Open407V_USART_RX -PC11
  */
  ...
  GPIO_Init(Open407V_USART_TX_GPIO_PORT, &GPIO_InitStructure);
...
// 	USART_NVIC_Config();
//  USART_ITConfig(Open407V_USART,USART_IT_TC,ENABLE);
...
void USART_NVIC_Config(void)
{
  ...
  NVIC_InitStructure.NVIC_IRQChannel = Open407V_USART_IRQn;
...
PUTCHAR_PROTOTYPE
{
  ...
  USART_SendData(Open407V_USART, (uint8_t) ch);

  /* Loop until the end of transmission */
  while (USART_GetFlagStatus(Open407V_USART, USART_FLAG_TC) == RESET)
  {}
